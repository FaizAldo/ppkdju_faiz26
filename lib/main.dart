...
class MyApp extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {//build method adalah method yang digunakan untuk membangun widget
    return MaterialApp(//MaterialApp adalah widget yang digunakan untuk mengatur tema, navigasi, dan lainnya dalam aplikasi
      title: 'Test App',//
      theme: ThemeData(//ThemeData adalah class yang digunakan untuk mengatur tema aplikasi
